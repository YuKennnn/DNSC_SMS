        ...
        <div class="container">
            ...
            <div class="p-4 p-md-5 mb-4 rounded text-body-emphasis bg-body-secondary d-flex">
                <div class="col-lg-8 px-0">
                    ...
                    <a href="services.php"
                        class="btn bg-success text-white border border-2 border-dark rounded-0 shadow px-4 py-2 rounded-pill">
                        Click Me
                    </a>
                </div>
    ...
    <section class="py-5 bg-light mt-5 mb-5">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <img src="https://images.pexels.com/photos/3184430/pexels-photo-3184430.jpeg"
                        class="img-fluid rounded shadow" alt="About Us">
                </div>
                <div class="col-lg-6">
                    <h2 class="fw-bold mb-4 text-success-emphasis">About Us</h2>
                    <p class="lead text-muted mb-4">I guess we are a passionate and dedicated to practicing our
                        programming skills.</p>
                    <p class="mb-4">Since we're only 2 students, we're trying our best to make this project work even
                        though we're trash  <--- (Edit: my classmate typed this one, so he is referring to himself XD).</p>
